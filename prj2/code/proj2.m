...
% image2 = imread('../data/Notre Dame/4191453057_c86028ce1f_o.jpg');
% eval_file = '../data/Notre Dame/921919841_a30df938f2_o_to_4191453057_c86028ce1f_o.mat';
% image1 = imread('../data/Pantheon Paris/5961334903_400148a5ff_o.jpg'); 
% image2 = imread('../data/Pantheon Paris/4872728253_3e73bd436b_o.jpg');
% eval_file = '../data/Pantheon Paris/921919841_a30df938f2_o_to_4191453057_c86028ce1f_o.mat';
% image1 = imread('../data/House/IMG_0488.JPG'); 
% image2 = imread('../data/House/IMG_2156.JPG');
% eval_file = '../data/House/921919841_a30df938f2_o_to_4191453057_c86028ce1f_o.mat';
...
% image2_bw = image2;
dim = size(image1_bw);
%image2_bw = imresize(image2_bw, dim);
